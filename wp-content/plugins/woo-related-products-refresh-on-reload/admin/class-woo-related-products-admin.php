 ...
 * @package    Woo_Related_Products
 * @subpackage Woo_Related_Products/admin
 * @author     EBOXNET.com <woorelated@eboxnet.com>
 */
class Woo_Related_Products_Admin {
	...
	*/
	add_submenu_page( 'woocommerce', __( 'Related Products', 'woocommerce' ), __( 'Woo Related Products', 'woocommerce' ), 'administrator', 'woo-related-options', 'admin_page' );
	}
	/**
